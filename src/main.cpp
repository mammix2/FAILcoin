...
uint256 hashGenesisBlock("0xd3221b0aeff5ac74ece3fea2f91572dfc4d214521d9cca435ab06a5d9e364022");
...
{
    int64 nSubsidy = 556677 * COIN;
    
    if(nHeight == 1)
    {
       nSubsidy = 345515000 * COIN;
    }
    else if(nHeight < 345)
    {
       nSubsidy = 1 * COIN;
    }
    nSubsidy >>= (nHeight / 70000);
    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 60 * 60; // FailCoin:every2hours
static const int64 nTargetSpacing = 30; // FailCoin: 30 sec blocks
...
unsigned int static GetNextWorkRequired_V3(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // thanks to RealSolid & WDC for the basis of this code, modified by Mammix2 for Failcoin
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    if (fTestNet) {
        ...
        printf("Into Main Net @ block # %d Diffmode: %d\n", pindexLast->nHeight+1, DiffMode );
    }
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal FailCoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbca8695ea1e57f34c0bc923a01a387a9a99757347c96e180b98261f668d80d83");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "This is FAIL! FailCoin Please stop FailCoins everyday";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1394215365; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 427592;

        if (fTestNet)
        {
            block.nTime    = 1394214679;
            block.nNonce   = 122765;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xbc0b0114d5951ae37d6fa5ab57f2b9c2fdf410fd49a1b582fee9521e2922bb7e"));
